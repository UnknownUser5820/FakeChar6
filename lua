					...
					if(MainCFrame.X~=oldMainCFrame.X or MainCFrame.Z~=oldMainCFrame.Z)then
						...
						if Attack == false then
							...
							CFrameAnimTable({
								...
								CFrame = Cf(0, 0-0.09*Sin(Sine/45), 0) *  Angles(Rad(0), Rad(180+5*Sin(Sine/45)), Rad(0));
							})
							CFrameAnimTable({
								Part=Head;
								Part2=Torso;
							...
							CFrameAnimTable({
								...
								CFrame = Cf(0.05,0+0.08*Sin(Sine/45),0+0.05*Sin(Sine/45)) * Angles(Rad(0),Rad(-8-25*Sin(Sine/45)),Rad(5));
							})
							CFrameAnimTable({
								Part=LeftLeg;
								Part2=Torso;
								...
								CFrame = Cf(0.06,0+0.09*Sin(Sine/45),0-0.05*Sin(Sine/45)) * Angles(Rad(0),Rad(23+25*Sin(Sine/45)),Rad(-5));
							})
						end
					end
				elseif Falling then 
